...
if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true) {
    header("Location: vote.php"); // Redirect to the main page if already logged in
    exit();
}
...
if (isset($_SESSION['lockout_time']) && time() < $_SESSION['lockout_time']) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($username === $admin_username && $password === $admin_password) {
            ...
            header("Location: vote.php"); // Redirect to the main page
            exit();
        } else {
...
<body>
    ...
    <div class="profile-section">
        <h1>CCS Voting System</h1>
        <p>Introducing the CCS Voting System for our school community! This innovative platform is designed to engage students, faculty, and staff in the democratic process, allowing everyone to have a voice in important decisions that affect our school environment.</p>
    </div>
