...
(1, 'DEPARTMENT ELECTION 2025-2026', 'Election for the New Officers', '2025-08-07 00:00:00', '2025-08-08 00:00:00', '2025-08-07 09:04:40', 1);
...
--
-- Table structure for table `student_candidates`
--
...
CREATE TABLE `student_candidates` (
  ...
  `vote_tally` int(99) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `student_candidates`
--

INSERT INTO `student_candidates` (`student_id`, `candidate_name`, `program`, `year_level`, `position`, `party`, `vote_tally`) VALUES
(2340081, 'LORRAINE ANNE G. LAURENTE', 'IT', '2ND YEAR', 'PRESIDENT', 'HAKDOG', 0);

-- --------------------------------------------------------

--
-- Table structure for table `student_candidates1`
--

CREATE TABLE `student_candidates1` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `student_candidates`
--
ALTER TABLE `student_candidates`
  ADD PRIMARY KEY (`student_id`),
  ADD UNIQUE KEY `student_id` (`student_id`),
  ADD UNIQUE KEY `name` (`candidate_name`);

--
-- Indexes for table `student_candidates1`
--
ALTER TABLE `student_candidates1`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `student_id` (`student_id`),
...
--
-- AUTO_INCREMENT for table `student_candidates`
--
ALTER TABLE `student_candidates`
  MODIFY `student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2440284;

--
-- AUTO_INCREMENT for table `student_candidates1`
--
ALTER TABLE `student_candidates1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `votes`
  ADD CONSTRAINT `votes_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_candidates1` (`id`) ON DELETE CASCADE,
